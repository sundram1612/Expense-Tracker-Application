      ...
      <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content border-0 rounded-4 shadow-lg">
          ...
          <div class="modal-header border-bottom-0 pb-0">
             <h5 class="modal-title fw-bold text-center w-100 text-body">Add Expense</h5>
          ...
          <div class="modal-body px-4 py-4">
            <form [formGroup]="form" (ngSubmit)="save()">
              ...
              <div class="mb-3 d-flex align-items-center justify-content-between">
                 <label class="form-label mb-0 fw-medium text-secondary">Category</label>
                 <select class="form-select fw-medium text-body" formControlName="category" style="width: 200px;">
              ...
              <div class="mb-4 d-flex align-items-center justify-content-between">
                 <label class="form-label mb-0 fw-medium text-secondary">Payment Method</label>
                 <select class="form-select fw-medium text-body" formControlName="paymentMethod" style="width: 200px;">

...
public interface ExpenseRepository extends JpaRepository<Expense, Long> {
    ...
    List<Expense> findByUserIdAndDateBetween(Long id, LocalDate from, LocalDate to);
    List<Expense> findByUserIdAndTypeAndDateBetween(Long userId, String type, LocalDate from, LocalDate to);
}
